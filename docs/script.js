...
// Observer le conteneur des barres de langages (premier parent commun des skill-fill)
const firstFill = document.querySelector('.skill-fill');
if (firstFill) {
    const barsContainer = firstFill.closest('[class="reveal"]') || firstFill.closest('section');
    if (barsContainer) skillObserver.observe(barsContainer);
}
